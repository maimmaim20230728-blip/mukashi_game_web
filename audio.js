...
var Sound = (function () {
  ...
  var TRACKS = {
    ...
    /* ---- タイトル(v1.7.0〜・国を特定しない「えほんの とびら」) ----
       オルゴール風=高い音域の琴だけを ゆっくりの3拍子で。太鼓・鼓・ドローンなし。8小節でひとまわり(kotoAltで F→G の流れ) */
    title: { bar: 3.0, vol: 0.036,
      koto: [[0,C5,.9],[.333,E5,.7],[.667,G5,.7],[.833,E5,.5]],
      kotoAlt: [[0,A4,.9],[.333,C5,.7],[.667,F5,.7],[.833,D5,.5]],
      fue: [[.05,G4,.55]], fueAlt: [[.05,E5,.5],[.6,D5,.35]],
      suzu: [.667], taiko: [], tsuzumi: [], drone: null }
  };
